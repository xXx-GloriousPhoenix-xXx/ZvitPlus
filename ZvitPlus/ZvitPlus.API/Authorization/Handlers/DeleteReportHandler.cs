...
{
    public class DeleteReportHandler(IReportService reportService, IHttpContextAccessor httpContextAccessor) : AuthorizationHandler<DeleteReportRequirement>
    {
        private readonly IReportService reportService = reportService;
        private readonly IHttpContextAccessor httpContextAccessor = httpContextAccessor;

        protected override async Task HandleRequirementAsync(AuthorizationHandlerContext context, DeleteReportRequirement requirement)
        {
